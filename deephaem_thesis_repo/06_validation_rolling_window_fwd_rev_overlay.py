...
#erythroid specific:
#
#captured in eyrhtroid tracks along with most heart tracks:
#
# df[3][(df[4]==0.95)&(df.index==304700)].unique()[0].split(',')
# captrues Ery don 001, 002, and 003
         # index     0         1         2                                                  3     4
# 304700  304700  chr9  96416527  96421482  Endothelial_Myocardial_ATAC,Mast_ATAC,Pericyte...  0.95
#so the peak is chr9  96416527  96421482 #4955bp 
#chosen region: chr9 96401549  96436460 #34911
# regionOI = 'chr9:96401549-96436460'

#Region 5:
#erythroid specific:
#
#captured in eyrhtroid track(s) and hardly any heart tracks:
#
# df[3][(df[4]<=0.10)&(df[3].str.contains('Ery'))&(df[0]=='chr2')&(df.index==140986)]
# only captrues Ery don 001, 002, and 003
         # index     0        1        2                                                  3     4
# 140986  140986  chr2  5074031  5075298  Ery_Don001_hg38_ATAC,Ery_Don003_hg38_ATAC,Ery_...  0.05
#so the peak is chr2  5074031  5075298 #1267
#chosen region: chr2 5064031  5085298 #21267
# regionOI = 'chr2:5064031-5085298'
...
#
# df[df.index==257696]
#so the peak is chr6  119626876  119628805 #1929
#chosen region: chr6  119616876  119638805  #21929
# regionOI = 'chr6:119616876-119638805'
...
#
# df[df.index==141087]
#so the peak is chr2  6846486  6848156 #1670
#chosen region: chr2  6836486  6858156  #21670
regionOI = 'chr2:6836486-6858156'
...
# pred_df.to_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/01_prediction40kb_forward.cvs', sep='\t')
# pred_df.to_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/02_prediction25kb_forward.cvs', sep='\t')
# pred_df.to_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/03_prediction27kb_forward.cvs', sep='\t')

# pred_df_rc.to_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/01_prediction40kb_reverse.cvs', sep='\t')
# pred_df_rc.to_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/02_prediction25kb_reverse.cvs', sep='\t')
# pred_df_rc.to_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/03_prediction27kb_reverse.cvs', sep='\t')

# pred_df = pd.read_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/01_prediction40kb_forward.cvs', sep='\t', index_col=0)
# pred_df = pd.read_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/02_prediction25kb_forward.cvs', sep='\t', index_col=0)
# pred_df = pd.read_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/03_prediction27kb_forward.cvs', sep='\t', index_col=0)

# pred_df_rc = pd.read_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/01_prediction40kb_reverse.cvs', sep='\t', index_col=0)
# pred_df_rc = pd.read_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/02_prediction25kb_reverse.cvs', sep='\t', index_col=0)
# pred_df_rc = pd.read_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/03_prediction27kb_reverse.cvs', sep='\t', index_col=0)

# pred_df = pd.read_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/01_prediction40kb_forward.cvs', sep='\t')
# pred_df.drop(['Unnamed: 0'], axis=1, inplace=True)

# pred_df_rc = pd.read_csv('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/01_prediction40kb_reverse.cvs', sep='\t')
...
for col in pred_df.columns:
    ...
    ax[2].set_title("")
    plt.show()
    fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window_ery_enhancer/sigmoid_65_validation_rolling_window_fwd_rev_region7_prediction_' + col + '_peak_centered.png', bbox_inches='tight')
    print('@'*100)
...
for col in pred_df.columns:
    ...
    plt.show()
    fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window_ery_enhancer/sigmoid_65_validation_rolling_window_only_overlay_region7_prediction_' + col + '_peak_centered.png', bbox_inches='tight')
    print('@'*100)

# region02 = 'chr9:163756-188756'

# for col in pred_df.columns:
#     fig, ax = plt.subplots(3,1,figsize=(150,30))
#     ax[0] = pred_df[col].plot.line(title=col, fontsize=50, ax=ax[0])
#     ax[0].get_xaxis().set_visible(False)
#     ax[1] = pred_df_rc[col].plot.line(title=col, fontsize=50, ax=ax[1])
#     ax[0].set_title(col, fontsize = 60)
#     ax[1].set_title("")
...
#     ax[2].set_title("")
#     plt.show()
#     fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/validation_rolling_window_fwd_rev_region2_prediction_' + col + '.png', bbox_inches='tight')
#     print('@'*100)
...
#     ax.set_title(col, fontsize = 60)
#     plt.show()
#     fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/validation_rolling_window_only_overlay_region2_prediction_' + col + '.png', bbox_inches='tight')
#     print('@'*100)
...
#     ax[2].set_title("")
#     plt.show()
#     fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/validation_rolling_window_fwd_rev_region3_prediction_' + col + '.png', bbox_inches='tight')
#     print('@'*100)
...
#     ax.set_title(col, fontsize = 60)
#     plt.show()
#     fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window/validation_rolling_window_only_overlay_region3_prediction_' + col + '.png', bbox_inches='tight')
#     print('@'*100)