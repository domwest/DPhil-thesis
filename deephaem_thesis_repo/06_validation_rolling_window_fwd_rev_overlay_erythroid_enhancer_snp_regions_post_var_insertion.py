...
# # /well/PROCARDIS/domwest/upstr_processing/UpStreamPipeline_old/reference_genomes/upstream_pipelines_output/Download_Index_Genomes/hg38_bowtie2/ref_genome_analysis/results/ery_enhancer_pos_control_rs198415.vcf
...
# #Rs198415; chr1    11841535   T   C

# #touch /well/PROCARDIS/domwest/upstr_processing/UpStreamPipeline_old/reference_genomes/upstream_pipelines_output/Download_Index_Genomes/hg38_bowtie2/ref_genome_analysis/results/ery_enhancer_pos_control_rs198415.vcf
# #add this:

# #CHROM  POS     ID      REF     ALT     QUAL    FILTER  INFO
# chr1    11841535        .       T       C       .       .       .

# #touch /well/PROCARDIS/domwest/upstr_processing/UpStreamPipeline_old/reference_genomes/upstream_pipelines_output/Download_Index_Genomes/hg38_bowtie2/ref_genome_analysis/results/ery_enhancer_pos_control_rs11177764.vcf
# #add this:
...
# bgzip ery_enhancer_pos_control_rs198415.vcf #lead_and_imp_vars.vcf
# tabix -p vcf ery_enhancer_pos_control_rs198415.vcf.gz #lead_and_imp_vars.vcf.gz

# module purge
# module load VCFtools

# #inserting variants into reference genome fasta file and saving it with new name:

# cat hg38.fa | vcf-consensus ery_enhancer_pos_control_rs198415.vcf.gz > hg38_edited_for_ery_enhancer_pos_control_rs198415.fa #cat hg38.fa | vcf-consensus lead_and_imp_vars.vcf.gz > hg38_edited_for_variants_lead_and_imp.fa

# module purge
# module load tabix

# bgzip ery_enhancer_pos_control_rs11177764.vcf #lead_and_imp_vars.vcf
# tabix -p vcf ery_enhancer_pos_control_rs11177764.vcf.gz #lead_and_imp_vars.vcf.gz
...
# cat hg38.fa | vcf-consensus ery_enhancer_pos_control_rs11177764.vcf.gz > hg38_edited_for_ery_enhancer_pos_control_rs11177764.fa #cat hg38.fa | vcf-consensus lead_and_imp_vars.vcf.gz > hg38_edited_for_variants_lead_and_imp.fa
...
def multi_allelic_visualisations(rsid, regionOI, ref, alt):
    ...
    for col in pred_df.columns:
        ...
        ax[2].set_title("")
        plt.show()
        fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window_ery_enhancer/sigmoid_65_validation_rolling_window_fwd_rev_1000bp_prediction_' + col + '_' + rsid + '_' + ref + '_' + alt + '_Enhancer_erythroid_pos_control_with_vars_variant_centered.png', bbox_inches='tight')
    ...
    for col in pred_df.columns:
        ...
        plt.show()
        fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window_ery_enhancer/sigmoid_65_validation_rolling_window_only_overlay_1000bp_prediction_' + col + '_' + rsid + '_' + ref + '_' + alt + '_Enhancer_erythroid_pos_control_with_vars_variant_centered.png', bbox_inches='tight')
...
#PART E).
#same bp as script to run centred on peak shows
...
snp_dataset['regionOI'] = snp_dataset['chr'].astype(str) + ':' + snp_dataset['downstream'].astype(str) + '-' + snp_dataset['upstream'].astype(str)
snp_dataset = snp_dataset.iloc[[176]]
...
def multi_allelic_visualisations(rsid, regionOI, ref, alt):
    ...
    for col in pred_df.columns:
        ...
        ax[2].set_title("")
        plt.show()
        fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window_ery_enhancer/sigmoid_65_validation_rolling_window_fwd_rev_20000ish_bp_prediction_' + col + '_' + rsid + '_' + ref + '_' + alt + '_Enhancer_erythroid_pos_control_with_vars_variant_centered.png', bbox_inches='tight')
        # fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window_ery_enhancer/sigmoid_65_validation_rolling_window_fwd_rev_prediction_' + col + '_' + rsid + '_' + ref + '_' + alt + '_Enhancer_erythroid_pos_control_with_vars.png', bbox_inches='tight')
        #print('@'*100)
    #
    for col in pred_df.columns:
        ...
        ax.set_title(col, fontsize = 60)
        plt.show()
        fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window_ery_enhancer/sigmoid_65_validation_rolling_window_only_overlay_20000ish_bp_prediction_' + col + '_' + rsid + '_' + ref + '_' + alt + '_Enhancer_erythroid_pos_control_with_vars_variant_centered.png', bbox_inches='tight')
        # fig.savefig('/well/PROCARDIS/domwest/deephaem_prep/input_files_for_deephaem/redo_fwd_rev_rolling_window_ery_enhancer/sigmoid_65_validation_rolling_window_only_overlay_prediction_' + col + '_' + rsid + '_' + ref + '_' + alt + '_Enhancer_erythroid_pos_control_with_vars.png', bbox_inches='tight')
        #print('@'*100)
